...
public class RedSwervePathFollower extends CommandBase {
     ...
     *                           controllers.
     * @param eventMap           Map of event marker names to the commands that
     *                           should run when reaching that marker.
     *                           This SHOULD NOT contain any commands requiring the
     *                           same subsystems as this command, or it will be
     *                           interrupted
    ...
    public void execute() {
        ...
        SmartDashboard.putNumber("RedSwerve_xError", currentPose.getX() - desiredState.poseMeters.getX());
        SmartDashboard.putNumber("RedSwerve_yError", currentPose.getY() - desiredState.poseMeters.getY());
        SmartDashboard.putNumber("RedSwerve_hError",
