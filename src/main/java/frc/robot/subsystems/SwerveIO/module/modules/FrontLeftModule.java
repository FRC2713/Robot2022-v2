...
public class FrontLeftModule extends SwerveModule {
    public FrontLeftModule(SwerveModuleIO swerveModuleIO) {
        super(swerveModuleIO, SwerveModules.FRONT_LEFT, new PIDFFController(DriveConstants.Gains.FrontLeft.kDefaultDrivingGains), new PIDFFController(DriveConstants.Gains.FrontLeft.kDefaultAzimuthGains));
    }
}
